...
export default function Navbar(){
    ...
    return(
        ...
        <img src="/logoNav.png" alt="GameZone Logo" className="w-[90px] sm:w-[120px] object-contain transition duration-300 group-hover:scale-105"/>
        ...
        <details className="dropdown lg:hidden">
          ...
          <div className="dropdown-content fixed left-1/2 -translate-x-44 top-[76px] w-[90vw] max-w-sm rounded-box border border-fuchsia-400 bg-[#07070B]/90 backdrop-blur-xl p-4 text-white shadow-sm">
            ...
            <div className="mt-4 flex flex-col gap-3">
              <Link className="inline-flex items-center gap-2 text-white font-semibold text-[15px] hover:text-fuchsia-400 transition duration-300" to={routes.home}>
                <SlHome className="text-[18px]" /> Home
              </Link>
              {user &&(
              ...
              <a href="#" className="text-zinc-300 font-semibold text-[15px] hover:text-fuchsia-400 transition duration-300">News</a>
              <a href="#" className="text-zinc-300 font-semibold text-[15px] hover:text-fuchsia-400 transition duration-300">Classifiche</a>
              <a href="#" className="text-zinc-300 font-semibold text-[15px] hover:text-fuchsia-400 transition duration-300">Contatti</a>
            </div>
          </div>
        </details>
